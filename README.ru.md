...
Вероятнее всего, вы знакомы с добавлением изменений в staging область, используя комманду git add.
...
Конечный результат выглядит следующим образом: [rebase picture]
